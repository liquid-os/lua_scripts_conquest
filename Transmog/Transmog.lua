...
local NPC_Entry = 500440

local RequireGold = 1
local GoldModifier = 0
local GoldCost = 0
...
local SlotNames = {
    [EQUIPMENT_SLOT_HEAD      ] = {generateIcon("Icons/inv_helmet_20", SIZE_ICON).." Head",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_SHOULDERS ] = {generateIcon("Icons/inv_shoulder_26", SIZE_ICON).." Shoulders",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BODY      ] = {generateIcon("Icons/inv_shirt_white_01", SIZE_ICON).." Shirt",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_CHEST     ] = {generateIcon("Icons/inv_chest_chain", SIZE_ICON).." Chest",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WAIST     ] = {generateIcon("Icons/inv_belt_02", SIZE_ICON).." Waist",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_LEGS      ] = {generateIcon("Icons/inv_pants_04", SIZE_ICON).." Legs",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_FEET      ] = {generateIcon("Icons/inv_boots_01", SIZE_ICON).." Feet",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WRISTS    ] = {generateIcon("Icons/inv_bracer_17", SIZE_ICON).." Wrists",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HANDS     ] = {generateIcon("Icons/inv_misc_desecrated_plategloves", SIZE_ICON).." Hands",        nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BACK      ] = {generateIcon("Icons/inv_misc_cape_18", SIZE_ICON).." Back",         nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_MAINHAND  ] = {generateIcon("Icons/inv_sword_06", SIZE_ICON).." Main hand",    nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_OFFHAND   ] = {generateIcon("Icons/inv_shield_04", SIZE_ICON).." Off hand",     nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_RANGED    ] = {generateIcon("Icons/inv_weapon_bow_02", SIZE_ICON).." Ranged",       nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_TABARD    ] = {generateIcon("Icons/inv_shirt_guildtabard_01", SIZE_ICON).." Tabard",       nil, nil, nil, nil, nil, nil, nil, nil},
}
local Locales = {
...
function SetFakeEntry(item, entry)
    local player = item:GetOwner()
    local curr = 0
    if(curr == nil or curr == 0 or item:GetEntry())then
        if player then
...
local function OnEquip(event, player, item, bag, slot)
    ...
    if fentry then
        if item:GetOwnerGUID() ~= player:GetGUIDLow() then
            DeleteFakeFromDB(item:GetGUIDLow())
            return
        end
...
RegisterGameObjectGossipEvent(1000048, 1, OnGossipHello)
RegisterGameObjectGossipEvent(1000048, 2, OnGossipSelect)
