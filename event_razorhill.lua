...
function On_Gossip(event, plr, unit)
	plr:GossipMenuAddItem(2, "I want to enter the Razor Hill Invasion event.", 0, 1, false, "This action will cost "..EVENT_COST.." x "..GetItemLink(EVENT_CURRENCY)..". Click accept to confirm.")
...
RegisterCreatureGossipEvent(50179, 1, On_Gossip)
RegisterCreatureGossipEvent(50179, 2, On_Select)
RegisterCreatureEvent(50179, 5, onRespawn)
